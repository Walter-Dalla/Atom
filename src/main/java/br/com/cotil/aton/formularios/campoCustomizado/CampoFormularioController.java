...
public class CampoFormularioController {
  ...
  @Autowired
  public CampoFormularioController(TokenService tokenService,
      CampoFormularioService campoFormularioService) {
    super();
  ...
  @GetMapping
  public List<CampoFormularioModel> listaFormularios(HttpServletRequest request,
  ...
  @PostMapping
  public CampoFormularioModel criaFormularios(HttpServletRequest request,
      @RequestHeader("Token") String token, @RequestBody CampoFormularioModel campoFormularioModel)
      throws BadRequestException, ForbiddenException {
  ...
  public CampoFormularioModel desabilitaFormulario(HttpServletRequest request,
      @RequestHeader("Token") String token,
