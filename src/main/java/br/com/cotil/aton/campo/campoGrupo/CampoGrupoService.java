...
public class CampoGrupoService {
  ...
  public CampoGrupoModel createConexaoEntreCampoEGrupo(UsuarioModel usuario, CampoCustomizadoModel campo,
      GrupoModel grupo) throws BadRequestException, ForbiddenException {
  ...
  private CampoCustomizadoModel validarCampo(CampoCustomizadoModel campo, UsuarioModel usuario) throws ForbiddenException, BadRequestException {
    
    Optional<CampoCustomizadoModel> campoOptional = campoCustomizadoRepository.findById(campo.getId());
  ...
  private GrupoModel validarGrupo(GrupoModel grupo, UsuarioModel usuario) throws BadRequestException, ForbiddenException {
